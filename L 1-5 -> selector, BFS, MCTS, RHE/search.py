...
def depthFirstSearch(problem):
    ...
    frontier = util.Stack()
    visited = []
    startNode = (problem.getStartState(),None, []) #first loc sec direction <- its not given any # statit, array of the commands to be
    ...
    while not frontier.isEmpty():
        ...
        currDir = curr[1]
        currPath = curr[2]
        print('curr:', curr, 'currLoc:', currLoc, 'currPath:', currPath)
...
def breadthFirstSearch(problem):
    ...
    startNode = (problem.getStartState(), None,
                 [])  # first loc sec direction <- its not given any # statit, array of the commands to be
    frontier.push(startNode)
    while not frontier.isEmpty():
        curr = frontier.pop()
        currLoc = curr[0]
